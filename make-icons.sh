sips -Z 512 static/icon-1024.png --out static/icon-512.png
sips -Z 384 static/icon-1024.png --out static/icon-384.png
...
sips -Z 32 static/icon-1024.png --out static/icon-32.png
sips -Z 32 static/icon-1024.png --out static/icon-24.png
sips -Z 32 static/icon-1024.png --out static/icon-16.png
# make favicon
