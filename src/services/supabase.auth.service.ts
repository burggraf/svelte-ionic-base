...
export default class SupabaseAuthService {
  ...
  private async loadUser() {
    ...
    const { data } = await SupabaseAuthService.supabase.auth.getUser();
  ...
  public signInWithEmail = async (email: string, password: string) => {
    console.log('SupabaseAuthService.supabase', SupabaseAuthService.supabase);
  ...
  public signInWithProvider = async (provider: Provider) => {
    const { data, error } = await SupabaseAuthService.supabase.auth.signInWithOAuth({
      provider: provider,
      options: {
  ...
  public resetPassword = async (email: string) => {
    const { data, error } = await SupabaseAuthService.supabase.auth.resetPasswordForEmail(email,
      {
  ...
  public sendMagicLink = async (email: string) => {
    ...
    const { data, error } = await SupabaseAuthService.supabase.auth.signInWithOtp({
      email: email,
      options: {
  ...
  public updatePassword = async (access_token: string, new_password: string) => {
    console.log('THIS IS OBSOLETE access_token: ', access_token);
    const { error, data } = await SupabaseAuthService.supabase.auth
